...
abstract class AuthResponse with _$AuthResponse {
  ...
  factory AuthResponse.fromJson(Map<String, dynamic> json) => AuthResponse(
    ...
    // Rotating refresh tokens — older responses (or stub data)
    // without the field decode as an empty string; callers treat
    // that as "no refresh available" and fall back to single-token
    // semantics.
